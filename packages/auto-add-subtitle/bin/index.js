...
var veed_auto_add_title_1 = require('./veed-auto-add-title');
            ...
            return [
              ...
              utils_1.changeFormat(
                files
                  ...
                  .map(function (file) {
                    return path_1.default.resolve(videoDir, file);
                  }),
                'mp3',
              ),
            ];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              utils_1.readdir(path_1.default.resolve(videoDir, TEMP_PATH)),
            ];
          case 1:
            parsedFiles = _b.sent();
            hasParsed = utils_1.makeMap(
              (parsedFiles || []).map(function (file) {
                return file
            ...
            return [
              4 /*yield*/,
              utils_1.readdir(path_1.default.resolve(videoDir)),
            ];
          case 2:
            files = _b.sent();
            return [
              4 /*yield*/,
              veed_auto_add_title_1.Veed.parseSubtitle(
                files
                  .filter(function (file) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            groupedFiles = files
              .filter(function (file) {
                return /chunks_\d+/.test(file);
              })
              .map(function (file) {
                return path_1.default.resolve(videoDir, TEMP_PATH + '/' + file);
              })
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Object.keys(groupedFiles).map(function (key) {
                  return subtitles_1.mergeSrtFiles(groupedFiles[key]);
                }),
              ),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                Object.keys(groupedFiles).map(function (key, i) {
                  return utils_1.writeFile(
                    path_1.default.resolve(
                      videoDir,
                      TEMP_PATH + '/' + key + '.srt',
                    ),
          ...
          case 1:
            ...
            return [
              ...
              Promise.all(
                files
                  .filter(function (file) {
                    return !/chunks/.test(file);
                  })
                  .filter(function (file) {
                    return /default_Project Name_(.+)\.mp3\.srt/.test(file);
                  })
                  .map(function (file) {
                    return path_1.default.resolve(
                      videoDir,

...
function withCache(fn) {
    ...
    return function (params) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = "" + prefix + base_1.md5(Array.isArray(params) ? params.join() : params) + ".json";
                    // hit cache
                    if (fs_1.default.existsSync(filePath)) {
                        return [2 /*return*/, fs_2.readFile(filePath).then(function (data) {
                ...
                case 1:
                    result = _a.sent();
                    return [4 /*yield*/, fs_2.writeFile(filePath, JSON.stringify(result))];
                case 2:
                    _a.sent();
...
function ensureCacheDirExists(cachePath) {

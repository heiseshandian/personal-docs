...
function getDuration(videoPath) {
  return new Promise(function (resolve) {
    child_process_1.exec('ffprobe ' + JSON.stringify(videoPath), function (
      err,
      _,
      stderr,
    ) {
...
function sliceMediaByChunks(mediaPath, chunks) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, getDuration(mediaPath)];
        case 1:
          duration = _b.sent();
          if (!duration) {
            return [2 /*return*/];
          ...
          (_a = path_1.default.parse(mediaPath)),
            (ext = _a.ext),
            (name = _a.name),
            (dir = _a.dir);
          return [
            4 /*yield*/,
            new concurrent_tasks_1.ConcurrentTasks(
              Array(chunks)
                .fill(0)
                .map(function (_, i) {
                  return function () {
                    ...
                    var cmd =
                      ...
                      chunkDuration +
                      ' -codec copy ' +
                      JSON.stringify(path_1.default.resolve(dir, outputPath));
                    return new Promise(function (resolve) {
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            new concurrent_tasks_1.ConcurrentTasks(
              mediaPaths.map(function (mediaPath) {
                return function () {
                  return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          chunks = Math.ceil(
                            getFileSize(mediaPath) / parseSize(maxSize),
                          );
                          if (chunks <= 1) {
                            return [2 /*return*/];
                          }
                    ...
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        ...
                        case 1:
                          ...
                          chunks = Math.ceil(
                            parseDuration(duration) / maxSeconds,
                          );
                          if (chunks <= 1) {
                            return [2 /*return*/];
                          }
...
function concatMedias(medias, output) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, prepareTmpFiles(medias)];
        case 1:
          tmpFilePath = _a.sent();
          if (!tmpFilePath) {
            return [2 /*return*/];
...
var parseFormat = function (filePath) {
  return path_1.default.parse(filePath).ext.slice(1);
};
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          videoPaths = videoPaths.filter(function (videoPath) {
            return parseFormat(videoPath) !== outputFormat;
          });
          return [
            4 /*yield*/,
            new concurrent_tasks_1.ConcurrentTasks(
              videoPaths.map(function (videoPath) {
                return function () {
                  var outputFile = videoPath.replace(
                    /\.\w+$/,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          (_a = path_1.default.parse(videos[0])),
            (dir = _a.dir),
            (name = _a.name);

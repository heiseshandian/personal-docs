...
function download(url, dest) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!url || !dest || !filenamify_1.default(dest)) {
...
function writeStreamToFile(stream, filePath) {
    stream.pipe(fs_1.default.createWriteStream(path_1.toValidFilePath(filePath)));
}
// 展示下载进度条
function showProgressBar(response) {
    var total = parseInt(response.headers['content-length'], 10);
    if (isNaN(total)) {
        return;
    }
    var bar = progress_1.MultiProgressBar.getProgressBar('downloading', { total: total });

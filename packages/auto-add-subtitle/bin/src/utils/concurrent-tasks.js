...
var ConcurrentTasks = /** @class */ (function () {
      ...
      return function () {
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                return [4 /*yield*/, task().catch(base_1.handleError)];
              case 1:
                result = _b.sent();
  ...
  ConcurrentTasks.prototype.withProgress = function (msg) {
    ...
    this.tasks = this.tasks.map(function (task) {
      return progress_1.withProgress(task, bar);
    });
  };
  ...
  ConcurrentTasks.prototype.run = function (maxConcurrent) {
    ...
    if (maxConcurrent === void 0) {
      maxConcurrent = os_1.default.cpus().length;
    }
    return new Promise(function (resolve) {
      _this.resolve = resolve;
      _this.tasks.slice(0, maxConcurrent).forEach(function (task) {

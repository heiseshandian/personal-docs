...
var puppeteer_extra_plugin_stealth_1 = __importDefault(
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              page.waitForSelector(selector, { timeout: timeout }),
            ];
          case 1:
            _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              page.waitForXPath(xpath, { timeout: timeout }),
            ];
          case 1:
            _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (_a = this.config),
              (inputFileSelector = _a.inputFileSelector),
              (timeout = _a.timeout);
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              uploadBtn === null || uploadBtn === void 0
                ? void 0
                : uploadBtn.uploadFile(audio),
            ];
          case 2:
            _b.sent();
            // 跳转编辑页面
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            (_a = this.config),
              (subtitleSelector = _a.subtitleSelector),
              (autoSubtitleSelector = _a.autoSubtitleSelector),
              (startXPath = _a.startXPath),
              (subtitlesSelector = _a.subtitlesSelector),
              (closeSelector = _a.closeSelector),
              (timeout = _a.timeout);
            return [
              4 /*yield*/,
              Promise.all([
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              page.waitForSelector(autoSubtitleSelector, { timeout: timeout }),
            ];
          case 4:
            _b.sent();
          ...
          case 6:
            ...
            return [
              4 /*yield*/,
              page.waitForSelector(subtitlesSelector, { timeout: timeout }),
            ];
          case 7:
            _b.sent();
            return [2 /*return*/];
          ...
          case 0:
            ...
            return [
              ...
              page._client.send('Browser.setDownloadBehavior', {
                behavior: 'allow',
                downloadPath: path_1.default.resolve(dir, 'parsed'),
              }),
            ];
          case 1:
            // https://chromedevtools.github.io/devtools-protocol/tot/Page/#method-setDownloadBehavior
            ...
            _b.sent();
            (_a = this.config),
              (translateXpath = _a.translateXpath),
              (downloadXpath = _a.downloadXpath);
          ...
          case 2:
            ...
            return [
              ...
              page.evaluate(function (xpath) {
                var _a;
                var downloadBtn = document.evaluate(
                  xpath,
                  document,
                  null,
                      ...
                      return __generator(this, function (_a) {
                        switch (_a.label) {
                          case 0:
                            return [
                              4 /*yield*/,
                              new utils_1.ConcurrentTasks(
                                audios.map(function (audio, i) {
                                  return function () {
                                    return __awaiter(
                                      _this,
                                      void 0,
